...
const conString = process.env.DATABASE_URL; // DONE TODO: Don't forget to set your own conString
...
// Creates request to github api. Is used as a callback for app.get . It protects our github token.
...
// Listens for request url for /new , /admin, & /github/* . Recieves http/ajax request from client. Executes responses.
...
// DONE COMMENT: What is this route doing? Where does it receive a request from?
// Updates authors/articles tables in database, based on specific article id. Gets request from Article.prototype.updateRecord in article.js.
